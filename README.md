...
3. **Registering New Organizations/ Agencies** - Agency IDs and Users are inserted as defined in [Agency User Map](https://docs.google.com/spreadsheets/d/1x-KUJgOhaZlZYzJ935q9QXhPM0yobjEEuN-IJgIvmwA/edit#gid=2080615206). When new Organizations/ Agencies are created, OSCaR and Primero teams will coordinate to manually register the new agencies in each system (this is _not_ an automated process). Primero agency names and users should follow the below naming conventions, _otherwise the OpenFn jobs must be updated_: 
